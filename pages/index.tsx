        ...
        <div className="min-h-screen w-full bg-[#212429]">
            <div className="mx-auto max-w-[1440px]">
                ...
                <main>
                    <section className="flex h-auto min-h-[934px]">
                        <div className="mt-[217px] w-1/2 pr-[82px] pl-[120px]">
                            ...
                            <p className="mt-[30px] text-lg font-normal leading-[30px] text-white text-opacity-60">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quis et tortor egestas mi
                                curabitur varius
                                dignissim viverra.
                            </p>
                            <button
                                className="my-[44px] rounded-[28px] bg-gradient-to-r from-[#FD6D1D] to-[#E53AD2] px-12 py-2.5 tracking-widestmore text-white text-opacity-90">
                                Explore
                            </button>
                        </div>
                        <div className="w-1/2">
                    ...
                    <AchievementSection achievementCards={[{
                        name: 'Tomahavk',
